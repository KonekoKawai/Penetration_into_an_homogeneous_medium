...
const int PIKSEL_IN_ON_M_INFO_L = 50; // Пикселей в одном метре  ДЛЯ экрана с информации о движении ударника
const int PIKSEL_IN_ON_M_INFO_V = 100; // Пикселей в одном метре  ДЛЯ экрана с информации о движении ударника
